...
//	}
	...
	// - Create a ResultSetExtractor obj ect and pass it as an argument
...
//		return jdbcTemplate.query(sql, new AccountExtractor(), creditCardNumber);
		return jdbcTemplate.query(sql, (ResultSetExtractor<Account>)(rs) -> {return  mapAccount(rs);},creditCardNumber);
    }
