...
public class AccountControllerBootTests {
	...
	public void createAccount() throws Exception {
		...
		mockMvc.perform(post("/accounts").contentType(APPLICATION_JSON).content(asJsonString(testAccount))).andExpect(status().isCreated()).andExpect(header().string("Location", "http://localhost/accounts/21"));
